...
const Page = async ({
  ...
  if (marketDetails.connectAccountId) {
    const response = await stripe.accounts.retrieve({
      stripeAccount: marketDetails.connectAccountId,
    })
  ...
  return (
    <div className="relative h-full">
      {!marketDetails.connectAccountId && (
        <div className="absolute -top-10 -left-10 right-0 bottom-0 z-30 flex items-center justify-center backdrop-blur-md bg-background/50">
          <Card>
            <CardHeader>
              ...
              <Link
                href={`/market/${marketDetails.id}/launchpad`}
        ...
        <div className="flex gap-4 flex-col xl:!flex-row">
          ...
          <Card className="flex-1 relative">
            <CardHeader>
              ...
              <CardTitle className="text-4xl">{vendors.length}</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
          ...
          <Card className="flex-1 relative">
            <CardHeader>
              <CardTitle>Market Goal</CardTitle>
              <CardDescription>
                <p className="mt-2">
            ...
            <CardFooter>
              <div className="flex flex-col w-full">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-muted-foreground text-sm">
                    Goal: {marketDetails.goal}
                  </span>
                </div>
                <Progress
                  value={(vendors.length / marketDetails.goal) * 100}
                />
              </div>
            </CardFooter>
