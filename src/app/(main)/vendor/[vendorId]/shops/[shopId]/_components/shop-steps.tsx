'use client'
import CreateShopPage from '@/components/forms/shop-page'
import CustomModal from '@/components/global/custom-modal'
import { AlertDialog } from '@/components/ui/alert-dialog'
import { Button } from '@/components/ui/button'
import { ScrollArea } from '@/components/ui/scroll-area'
import { toast } from '@/components/ui/use-toast'
import { upsertShopPage } from '@/lib/queries'
import { ShopsForVendor } from '@/lib/types'
...
import ShopPagePlaceholder from '@/components/icons/shop-page-placeholder'
...
import ShopStepCard from './shop-step-card'
...
const ShopSteps = ({ shop, shopId, pages, vendorId }: Props) => {
  const [clickedPage, setClickedPage] = useState<ShopPage | undefined>(
    pages[0]
  )
        ...
        <aside className="flex-[0.3] bg-background p-6  flex flex-col justify-between ">
          ...
          <Button
            ...
            onClick={() => {
              setOpen(
                <CustomModal
                  title=" Create or Update a Shop Page"
                  subheading="Shop Pages allow you to create step by step processes for customers to follow"
                >
                  <CreateShopPage
                    vendorId={vendorId}
                    shopId={shopId}
              ...
              <CardHeader>
                ...
                <CardDescription className="flex flex-col gap-4">
                  <div className="border-2 rounded-lg sm:w-80 w-full  overflow-clip">
                    <Link
                      href={`/vendor/${vendorId}/shops/${shopId}/editor/${clickedPage?.id}`}
                    ...
                    <Link
                      target="_blank"
                      href={`${process.env.NEXT_PUBLIC_SCHEME}${shop.subDomainName}.${process.env.NEXT_PUBLIC_DOMAIN}/${clickedPage?.pathName}`}
                    ...
                    >
                      ...
                      <div className="w-64 overflow-hidden overflow-ellipsis ">
                        ...
                        {shop.subDomainName}.{process.env.NEXT_PUBLIC_DOMAIN}/
