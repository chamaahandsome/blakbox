...
//     product: process.env.NEXT_ECON_PRODUCT_ID,
//     active: true,
//   })
  ...
  return (
    <>
      <section className="h-full w-full md:pt-44 mt-[-70px] relative flex items-center justify-center flex-col ">
        ...
        <p className="text-center">Run your market all year round!</p>
        <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
          <h1 className="text-9xl font-bold text-center md:text-[300px]">
            eCON
          </h1>
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-40 mt-[-60px]">
        ...
        <p className="text-muted-foreground text-center">
        Our pricing plans are designed to meet the needs of both small and large marketplaces. 
        {"you're"} not <br /> 
