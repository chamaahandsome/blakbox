...
interface VendorDetailsProps {
  //To add the vendor to the market
  marketDetails: Market
  details?: Partial<Vendor>
  userId: string
  userName: string
}
...
const VendorDetails: React.FC<VendorDetailsProps> = ({
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      toast({
        title: 'Vendor details saved',
        description: 'Successfully saved your vendor details.',
      })
      ...
      toast({
        variant: 'destructive',
        title: 'Sorry!',
        description: 'Could not save vendor details.',
      })
    }
  }
        ...
        <Form {...form}>
          ...
          >
            ...
            <Button
              ...
              disabled={isLoading}
            >
              {isLoading ? <Loading /> : 'Save Vendor Information'}
            </Button>
          </form>
        </Form>
      </CardContent>
